...
const SLIDE_PLATFORMS = [
  ...
  },
  {
    ...
    name: "Instagram",
    color: "#E1306C",
    bg: "rgba(193,53,132,0.18)",
  },
  { id: "tiktok", name: "TikTok", color: "#fff", bg: "rgba(255,255,255,0.1)" },
  {
    id: "youtube",
    name: "YouTube",
    color: "#FF0000",
  ...
  { id: "github", name: "GitHub", color: "#fff", bg: "rgba(255,255,255,0.1)" },
  { id: "gpt", name: "GPT", color: "#10A37F", bg: "rgba(16,163,127,0.18)" },
  {
    id: "google",
    name: "Google",
    color: "#4285F4",
  ...
  },
  {
    ...
    name: "Spotify",
    color: "#1DB954",
    bg: "rgba(29,185,84,0.18)",
  },
  { id: "x", name: "X", color: "#fff", bg: "rgba(255,255,255,0.1)" },
  {
    id: "claude",
    name: "Claude",
    color: "#CC7744",
    bg: "rgba(204,119,68,0.18)",
  },
  {
    id: "signal",
    name: "Signal",
    ...
    case "instagram":
      return (
        <svg {...p}>
          ...
          <title>{name}</title>
          <defs>
            <linearGradient id="ig-sl" x1="0%" y1="100%" x2="100%" y2="0%">
    ...
    case "claude":
      return (
        <svg {...p} fill={color}>
          <title>{name}</title>
          <title>{name}</title>
          <path d="M11.999 0C5.373 0 0 5.372 0 12s5.373 12 11.999 12C18.626 12.001 24 18.628 24 12 24 5.372 18.626 0 11.999 0zM6.54 14.255l2.96-9.404h1.044l-2.96 9.404H6.54zm7.16.094l-2.96-9.404h1.045l2.96 9.404h-1.045z" />
        </svg>
      );
    case "signal":
      return (
    ...
    case "gmail":
      return (
        <svg {...p}>
          ...
          <path
            fill="#EA4335"
            d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-2.023 2.309-3.178 3.927-1.964L5.455 4.64 12 9.548l6.545-4.909 1.528-1.147C21.69 2.28 24 3.434 24 5.457z"
          />
        </svg>
      );
    case "openclaw":
...
export function WorksWithLogoSlide() {
  ...
  // Double the list so the scroll is seamless
  const items = [...SLIDE_PLATFORMS, ...SLIDE_PLATFORMS];
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          width: 80,
          background: "linear-gradient(to right, #04040e, transparent)",
          zIndex: 2,
          pointerEvents: "none",
        }}
      />
      <div
        style={{
          ...
          bottom: 0,
          width: 80,
          background: "linear-gradient(to left, #04040e, transparent)",
          zIndex: 2,
          pointerEvents: "none",
        }}
      />
      ...
      <div style={{ overflow: "hidden" }}>
        <div className="ww-slide-track">
          {items.map((p, i) => (
            <div
              key={i < SLIDE_PLATFORMS.length ? `a-${p.id}` : `b-${p.id}`}
              style={{
                display: "flex",
            ...
            >
              <PlatformIcon id={p.id} color={p.color} name={p.name} />
              <span
                style={{
                  fontSize: "0.6rem",
