...
const INTEGRATIONS = [
  ...
  { id: "slack", name: "Slack", color: "#E01E5A", bg: "rgba(224,30,90,0.12)" },
  {
    id: "openai",
    name: "OpenAI",
    color: "#10A37F",
  ...
  { id: "x", name: "X", color: "#ffffff", bg: "rgba(255,255,255,0.08)" },
  {
    id: "google",
    name: "Google",
    color: "#4285F4",
    ...
    case "gemini":
      return (
        <svg {...p}>
          <title>{name}</title>
          <defs>
            <linearGradient id="gem-s" x1="0%" y1="0%" x2="100%" y2="100%">
...
export function IntegrationLogoSlider() {
  ...
  return (
    ...
    >
      <style>{`
        @keyframes slide-right-integ {
          from { transform: translateX(-50%); }
          to { transform: translateX(0%); }
        }
        .integ-track {
          animation: slide-right-integ 40s linear infinite;
        }
        .integ-track:hover {
          animation-play-state: paused;
        }
        @keyframes card-shimmer {
          0%, 100% { box-shadow: 0 0 0 1px rgba(255,255,255,0.06), 0 0 12px rgba(255,255,255,0.02); }
          50% { box-shadow: 0 0 0 1px rgba(255,255,255,0.12), 0 0 20px rgba(255,255,255,0.06); }
        }
        .integ-card {
      ...
      <div
        ...
        style={{
          background: "linear-gradient(to right, #080812, transparent)",
        }}
      />
      <div
        className="absolute inset-y-0 right-0 w-32 z-10 pointer-events-none"
        style={{ background: "linear-gradient(to left, #080812, transparent)" }}
      />
      ...
      <div className="text-center mb-8 px-4">
        ...
        <p className="text-sm text-gray-400 mt-1">
          Connect with the world&apos;s leading platforms
        </p>
      </div>

      {/* Scrolling track */}
      <div className="overflow-hidden" ref={trackRef}>
        <div className="integ-track flex gap-5 items-stretch w-max">
          {DUPLICATED.map((item, i) => (
            <div
              key={`${item.id}-${i}`}
              className="integ-card flex flex-col items-center gap-2 px-5 py-4 rounded-2xl shrink-0 cursor-default select-none"
              style={
                {
                  background: `linear-gradient(145deg, ${item.bg}, rgba(15,15,30,0.9))`,
            ...
            >
              <div
                ...
                style={{
                  background: `radial-gradient(circle at 40% 40%, ${item.color}20, transparent 70%)`,
                  boxShadow: `0 0 18px ${item.color}30, inset 0 0 8px ${item.color}10`,
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, #06b6d4, #a78bfa, transparent)",
        }}
      />
    </section>
  );
